      ...
      <div className="glass border-neon rounded-2xl p-8 space-y-6">
        ...
        <section>
          ...
          <div className="space-y-3 ml-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-muted-foreground">Contact our customer service team at <a href="tel:+18774195028" className="underline text-primary">+1 (877) 419-5028</a></p>
            </div>
            <div className="flex items-start gap-3">
        ...
        <section>
          ...
          <div className="mt-4 p-4 bg-primary/10 rounded-lg">
            ...
            <p className="text-muted-foreground">Phone: <a href="tel:+18774195028" className="underline hover:text-primary">+1 (877) 419-5028</a></p>
